...
<div class="box">
            ...
            <div class="box-body">
              ...
              @if (!empty(setting()->logo))
                <img src="{{ Storage::url(setting()->logo) }}" width="80px" height="80px"> 
              @endif
              </div>
              <div class="form-group">
               ...
               @if (!empty(setting()->icon))
                <img src="{{ Storage::url(setting()->icon) }}" width="80px" height="80px"> 
              @endif
              </div>
               <div class="form-group">
              ...
              <div class="form-group">
                ...
                {!! Form::select('status',['open'=>trans('admin.open'),'close'=>trans('admin.closed')],setting()->status,['class'=>'form-control']) !!}
              </div>
               <div class="form-group">
