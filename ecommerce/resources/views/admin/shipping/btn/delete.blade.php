<!--Data table errors may be in this pagein <h4> delete this record-->
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h4>{{ trans('admin.delete_this_record',['name'=>Session('lang')=='en'? $shipping_name_en: $shipping_name_ar]) }}</h4>
      </div>
