 <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
                <li><a href="{{ aurl('lang/ar') }}">عربي <i class="fa fa-flag-o"></i></a></li>   
                <li><a href="{{ aurl('lang/en') }}">English <i class="fa fa-flag-o"></i></a></li>
            </ul>
          </li>
          <!-- User Account: style can be found in dropdown.less -->
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ url('desgin/adminlte') }}/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
