...
<head>
  ...
  @else
  <link rel="stylesheet" href="{{ url('/') }}/desgin/adminlte/dist/css/rtl/AdminLTE.min.css">
  <link rel="stylesheet" href="{{ url('/') }}/desgin/adminlte/dist/css/rtl/bootstrap-rtl.min.css">
  <link rel="stylesheet" href="{{ url('/') }}/desgin/adminlte/dist/css/rtl/rtl.css">
  <link rel="stylesheet" href="{{ url('/') }}/desgin/adminlte/jstree/themes/default/style.css">
