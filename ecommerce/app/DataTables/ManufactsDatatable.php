    ...
    protected function getColumns()
    {
        return [
            ...
            [
                ...
                'name'=>'manufact_name_ar',
                'data'=>'manufact_name_ar',
                'title'=>trans('admin.manufact_name_ar'),
            ],[
                'name'=>'manufact_name_en',
                'data'=>'manufact_name_en',
                'title'=>trans('admin.manufact_name_en'),
            ],[
                'name'=>'mobile',
                'data'=>'mobile',
